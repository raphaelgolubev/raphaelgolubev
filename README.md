...
начал изучать фронтенд стэк (`JS/HTML/CSS`) и реляционные СУБД (`sqllite, Microsoft T-SQL`). Далее я защитил [дипломный проект](https://github.com/raphaelgolubev/golubev_diplom) (это всё, что от него осталось), 
