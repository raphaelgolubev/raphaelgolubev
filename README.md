...
### Обо мне
- Сейчас я работаю над своим мессенджером (который может перерасти во что-то еще) и стараюсь не использовать LLM в коде:
    - [backend](https://github.com/raphaelgolubev/anomer-backend)
    - [frontend (web)](https://github.com/raphaelgolubev/anomer-web)
- Еще я работаю над своей средой разработки [Blup IDE](https://github.com/raphaelgolubev/blup-ide)
- 🎂 Мне 26 лет
